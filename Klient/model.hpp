...
{
	public:
	KlientNode(int port0, int port1) : CommunicationNode(port0,port1) {}
    ...
    unique_ptr<Komunikat> createKomunikat(std::string)
    {
...
class Model
{
	...
	// Wezel komunikacji
	KlientNode* klientNode = new KlientNode(numerPortuSerwera, numerPortuKlienta);
	// Nazwa serwera.
